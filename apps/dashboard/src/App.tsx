        ...
        <div className="flex">
          ...
          <main className="flex-1 p-6 ml-64 mt-16">
            <Routes>
              ...
              <Route path="/trace" element={<ComingSoon title="Audit Trace" description="Complete audit trail of all system activity" />} />
              <Route path="/docs" element={<ComingSoon title="API Documentation" description="Complete API reference and guides" />} />
              <Route path="/auth/callback" element={<AuthCallback onAuthenticate={handleAuthenticate} />} />
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] text-center">
      <div className="w-16 h-16 rounded-2xl bg-surface-800 border border-surface-600 flex items-center justify-center mb-4">
        <svg className="w-8 h-8 text-lattice-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
