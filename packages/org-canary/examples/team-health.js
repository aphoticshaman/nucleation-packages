...
async function main() {
  ...
  const acquirerCulture = new Float64Array([0.15, 0.30, 0.15, 0.10, 0.15, 0.15]); // Hierarchical, formal
  const targetCulture = new Float64Array([0.35, 0.05, 0.25, 0.20, 0.10, 0.05]);   // Innovative, flat
