...
const WasmSwarmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
export class WasmSwarm {
     ...
     * @param {bigint} seed
     */
    constructor(n_particles, dt, diffusion, interaction_strength, attractor_x, attractor_y, attractor_strength, seed) {
        const ret = wasm.wasmswarm_new(n_particles, dt, diffusion, interaction_strength, attractor_x, attractor_y, attractor_strength, seed);
