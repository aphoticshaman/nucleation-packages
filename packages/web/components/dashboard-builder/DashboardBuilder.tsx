...
const TEMPLATES: { name: string; icon: string; widgets: Widget[] }[] = [
  {
    ...
    widgets: [
      ...
      { id: 'w3', type: 'stat_card', position: { x: 6, y: 0, w: 3, h: 2 }, title: 'Sources', config: { value: '234', label: 'Active feeds', icon: '📡', trend: 'up' } },
      { id: 'w4', type: 'stat_card', position: { x: 9, y: 0, w: 3, h: 2 }, title: 'Confidence', config: { value: '94%', label: 'Avg. accuracy', icon: '✓', trend: 'up' } },
