...
export function StudyBookOverlay() {
  const { isOpen, isMinimized, close, minimize, maximize } = useStudyBook();
  ...
  // Hide completely when not open (but keep mounted to preserve state once opened)
  // Use CSS to hide when minimized to preserve chat state
  ...
  return (
    ...
    >
      <div className="fixed inset-4 md:inset-8 lg:inset-12 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 rounded-2xl border border-white/10 shadow-2xl overflow-hidden flex flex-col">
        {/* Header */}
        <header className="border-b border-white/10 bg-black/40 backdrop-blur-xl flex-shrink-0">
          <div className="px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-bold text-lg text-white">Study Book</h1>
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3 py-1.5 text-sm rounded-lg bg-white/5 hover:bg-white/10 transition flex items-center gap-2 text-white"
              >
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <aside className="w-56 border-r border-white/10 p-4 hidden lg:block overflow-y-auto flex-shrink-0">
            {/* Mode Selection */}
            <div className="mb-6">
          ...
          <main className="flex-1 flex flex-col min-w-0">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {messages.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center">
                  ...
                  <h2 className="text-xl font-semibold mb-2 text-white">Welcome to Study Book</h2>
            ...
            {/* Input */}
            <div className="border-t border-white/10 p-4 bg-black/20 backdrop-blur-xl flex-shrink-0">
              <div className="max-w-4xl mx-auto">
                ...
                <div className="relative">
                  <textarea
                    ...
                    rows={1}
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 pr-12 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500/50 placeholder-slate-500 text-white"
