...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'training_backups') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'training_quarantine') THEN
    ALTER TABLE public.training_quarantine ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;

-- nation_changes - Historical nation change records
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'nation_changes') THEN
    ALTER TABLE public.nation_changes ENABLE ROW LEVEL SECURITY;
  END IF;
END $$;
...
-- Wrapped in DO blocks to handle missing dependencies gracefully
-- ============================================
...
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE ''Could not create admin_consumer_overview: %'', SQLERRM;
END $$;
...
DO $$ BEGIN
  ...
  END IF;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE ''Could not create admin_enterprise_overview: %'', SQLERRM;
END $$;
...
DO $$ BEGIN
  ...
  END IF;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE ''Could not create admin_dashboard_stats: %'', SQLERRM;
END $$;
...
DO $$ BEGIN
  ...
  END IF;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE ''Could not create exportable_training_data: %'', SQLERRM;
END $$;
...
DO $$ BEGIN
  ...
  END IF;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE ''Could not create nations_at_risk: %'', SQLERRM;
END $$;
...
DO $$ BEGIN
  ...
  END IF;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE ''Could not create admin_trial_invites: %'', SQLERRM;
END $$;
...
DO $$ BEGIN
  ...
  END IF;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE ''Could not create training_data_stats: %'', SQLERRM;
END $$;
...
DO $$ BEGIN
  ...
  END IF;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE ''Could not create country_risk_score: %'', SQLERRM;
END $$;
...
DO $$ BEGIN
  ...
  END IF;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE ''Could not create nations_geojson: %'', SQLERRM;
END $$;
...
DO $$ BEGIN
  ...
  END IF;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE ''Could not create edges_geojson: %'', SQLERRM;
END $$;
...
DO $$ BEGIN
  ...
  END IF;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE ''Could not modify spatial_ref_sys permissions: %'', SQLERRM;
END $$;

-- ============================================
-- 10. Add comment if table exists
-- ============================================
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'training_examples') THEN
