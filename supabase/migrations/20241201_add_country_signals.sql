...
CREATE INDEX idx_country_signals_country ON country_signals(country_code);
CREATE INDEX idx_country_signals_indicator ON country_signals(indicator);
CREATE INDEX idx_country_signals_year ON country_signals(year DESC);
CREATE INDEX idx_country_signals_source ON country_signals(source);
CREATE INDEX idx_country_signals_updated ON country_signals(updated_at DESC);

-- Composite index for common queries
CREATE INDEX idx_country_signals_country_indicator ON country_signals(country_code, indicator, year DESC);
...
CREATE MATERIALIZED VIEW country_signals_latest AS
...
CREATE UNIQUE INDEX idx_country_signals_latest_pk
